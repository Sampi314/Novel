...
class NamesGenerator {
  ...
  getNameBases(): NameBase[] {
    ...
    return [
      ...
      // Vietnamese-Chinese fantasy culture bases (Thien Hoang Dai Luc):
      {
        name: "Long Tộc",
        i: 43,
        min: 4,
        ...
        d: "n",
        m: 0,
        b: "Long Thiên,Long Vương,Long Phong,Long Minh,Long Hào,Long Khởi,Long Vân,Long Lâm,Long Đức,Long Cường,Long Phúc,Long Linh,Long Uy,Thiên Long,Thiên Vân,Thiên Phong,Thiên Lâm,Thiên Minh,Thiên Hoàng,Thiên Khai,Vân Long,Vân Phong,Vân Minh,Vân Hào,Vân Linh,Phong Lâm,Phong Hào,Phong Vương,Phong Minh,Phong Vân,Lâm Phong,Lâm Thiên,Lâm Vân,Lâm Long,Lâm Minh,Hào Thiên,Hào Long,Hào Phong,Hào Vân,Hào Lâm,Vương Long,Vương Thiên,Vương Phong,Vương Minh,Vương Hào,Minh Long,Minh Thiên,Minh Vương,Minh Phong,Minh Lâm,Hoàng Long,Hoàng Thiên,Hoàng Vân,Hoàng Phong,Hoàng Minh,Khai Long,Khai Thiên,Khai Phong,Khai Minh,Khai Vân,Linh Long,Linh Thiên,Linh Phong,Linh Vân,Linh Lâm,Uy Long,Uy Thiên,Uy Phong,Uy Vương,Uy Vân,Cường Long,Cường Thiên,Cường Phong,Cường Vương,Cường Vân,Đức Long,Đức Thiên,Đức Vương,Đức Minh,Đức Phong,Phúc Long,Phúc Thiên,Phúc Vân,Phúc Minh,Phúc Lâm,Long Khai Phong,Thiên Vân Long,Vương Minh Đức,Hoàng Long Vân,Khai Minh Phúc,Long Uy Vương,Thiên Cường Đức,Vân Linh Long,Phong Hào Thiên,Minh Đức Long",
      },
      {
        name: "Nhân Tộc",
        i: 44,
        ...
        d: "n",
        m: 0,
        b: "Nguyễn Anh,Nguyễn Hùng,Nguyễn Tuấn,Nguyễn Minh,Nguyễn Hải,Trần Anh,Trần Hùng,Trần Tuấn,Trần Minh,Trần Hải,Lê Anh,Lê Hùng,Lê Tuấn,Lê Minh,Lê Hải,Phạm Anh,Phạm Hùng,Phạm Tuấn,Phạm Minh,Phạm Hải,Hoàng Anh,Hoàng Hùng,Hoàng Tuấn,Hoàng Minh,Hoàng Hải,Phan Anh,Phan Hùng,Phan Tuấn,Phan Minh,Phan Hải,Vũ Anh,Vũ Hùng,Vũ Tuấn,Vũ Minh,Vũ Hải,Đặng Anh,Đặng Hùng,Đặng Tuấn,Đặng Minh,Đặng Hải,Bùi Anh,Bùi Hùng,Bùi Tuấn,Bùi Minh,Bùi Hải,Đỗ Anh,Đỗ Hùng,Đỗ Tuấn,Đỗ Minh,Đỗ Hải,Nguyễn Đức,Trần Khánh,Lê Quang,Phạm Thắng,Hoàng Duy,Phan Thành,Vũ Long,Đặng Khoa,Bùi Huy,Đỗ Phong,Nguyễn Văn Anh,Trần Văn Tuấn,Lê Văn Minh,Phạm Văn Hùng,Hoàng Văn Hải,Nguyễn Trung,Trần Bảo,Lê Nhật,Phạm Quốc,Hoàng Sơn,Phan Vĩnh,Vũ Định,Đặng Trí,Bùi Quang,Đỗ Thành,Nguyễn Thái,Trần Ngọc,Lê Hoàng,Phạm Gia,Hoàng Tiến,Nguyễn Bình,Trần Phúc,Lê Khang,Phạm Cường,Hoàng Vũ,Phan Đại,Vũ Nhân,Đặng Luân,Bùi Tân,Đỗ Kiên",
      },
      {
        name: "Yêu Tộc",
        i: 45,
        ...
        d: "n",
        m: 0,
        b: "Huyền Âm,Huyền Ma,Huyền Linh,Huyền Diệu,Huyền Dạ,Huyền Hắc,Âm Ma,Âm Quỷ,Âm Linh,Âm Diệu,Âm U,Âm Dạ,Âm Hắc,Ma Linh,Ma Quỷ,Ma Diệu,Ma U,Ma Dạ,Ma Hắc,Ma Yêu,Quỷ Linh,Quỷ Diệu,Quỷ Âm,Quỷ U,Quỷ Dạ,Quỷ Hắc,Linh Diệu,Linh Âm,Linh U,Linh Dạ,Linh Hắc,Linh Ma,Diệu Huyền,Diệu Ma,Diệu Âm,Diệu U,Diệu Dạ,U Minh,U Âm,U Linh,U Dạ,U Hắc,U Huyền,Minh Dạ,Minh Hắc,Minh Âm,Minh Yêu,Dạ Huyền,Dạ Linh,Dạ Ma,Dạ Quỷ,Dạ Diệu,Dạ Hắc,Hắc Âm,Hắc Linh,Hắc Ma,Hắc U,Hắc Dạ,Yêu Linh,Yêu Ma,Yêu Diệu,Yêu Huyền,Yêu Hắc,Mỵ Linh,Mỵ Diệu,Mỵ Huyền,Mỵ Dạ,Mỵ Âm,Tinh Linh,Tinh Yêu,Tinh Ma,Tinh Huyền,Huyền Yêu Ma,Âm Hắc Linh,Ma Diệu Huyền,Quỷ U Minh,Dạ Yêu Tinh,Hắc Âm Linh,U Minh Dạ,Linh Yêu Hắc,Diệu Ma U,Huyền Tinh Dạ",
      },
      {
        name: "Tinh Linh",
        i: 46,
        ...
        d: "n",
        m: 0,
        b: "Tinh Hoa,Tinh Ngọc,Tinh Tuyết,Tinh Sương,Tinh Lan,Tinh Phương,Tinh Thiên,Tinh Diệp,Tinh Vân,Linh Hoa,Linh Ngọc,Linh Tuyết,Linh Sương,Linh Lan,Linh Phương,Linh Thiên,Linh Diệp,Linh Vân,Hoa Ngọc,Hoa Tuyết,Hoa Sương,Hoa Lan,Hoa Phương,Hoa Thiên,Hoa Diệp,Ngọc Tuyết,Ngọc Sương,Ngọc Lan,Ngọc Phương,Ngọc Thiên,Ngọc Diệp,Ngọc Vân,Tuyết Sương,Tuyết Lan,Tuyết Phương,Tuyết Thiên,Tuyết Diệp,Tuyết Vân,Sương Lan,Sương Phương,Sương Thiên,Sương Diệp,Sương Vân,Lan Phương,Lan Thiên,Lan Diệp,Lan Vân,Phương Thiên,Phương Diệp,Phương Vân,Thiên Diệp,Thiên Vân,Diệp Vân,Tinh Linh Hoa,Hoa Ngọc Lan,Tuyết Sương Vân,Thiên Phương Diệp,Ngọc Lan Phương,Linh Hoa Tuyết,Tinh Vân Sương,Hoa Diệp Thiên,Lan Tuyết Ngọc,Phương Linh Hoa",
      },
      {
        name: "Trùng Tộc",
        i: 47,
        ...
        d: "n",
        m: 0,
        b: "Câu Trùng,Câu Du,Câu Kỳ,Câu Độc,Câu Châu,Câu Giáp,Câu Trúc,Câu Kiến,Câu Ong,Trùng Du,Trùng Kỳ,Trùng Độc,Trùng Châu,Trùng Giáp,Trùng Trúc,Trùng Kiến,Trùng Ong,Du Kỳ,Du Độc,Du Châu,Du Giáp,Du Trúc,Du Kiến,Du Ong,Kỳ Độc,Kỳ Châu,Kỳ Giáp,Kỳ Trúc,Kỳ Kiến,Kỳ Ong,Độc Châu,Độc Giáp,Độc Trúc,Độc Kiến,Độc Ong,Châu Giáp,Châu Trúc,Châu Kiến,Châu Ong,Giáp Trúc,Giáp Kiến,Giáp Ong,Trúc Kiến,Trúc Ong,Kiến Ong,Câu Trùng Du,Du Kỳ Độc,Châu Giáp Trúc,Độc Kiến Ong,Trùng Câu Kỳ,Kỳ Giáp Châu,Ong Trúc Kiến,Du Độc Châu,Câu Ong Trúc,Trùng Độc Giáp",
      },
      {
        name: "Cự Tộc",
        i: 48,
        ...
        d: "n",
        m: 0,
        b: "Sơn Nham,Sơn Cường,Sơn Hùng,Sơn Đại,Sơn Thạch,Sơn Thiết,Sơn Lôi,Sơn Vi,Nham Cường,Nham Hùng,Nham Đại,Nham Thạch,Nham Thiết,Nham Lôi,Nham Vi,Cường Hùng,Cường Đại,Cường Thạch,Cường Thiết,Cường Lôi,Cường Vi,Hùng Sơn,Hùng Nham,Hùng Đại,Hùng Thạch,Hùng Thiết,Hùng Lôi,Hùng Vi,Đại Sơn,Đại Nham,Đại Cường,Đại Thạch,Đại Thiết,Đại Lôi,Đại Vi,Thạch Sơn,Thạch Nham,Thạch Đại,Thạch Thiết,Thạch Lôi,Thạch Vi,Thiết Sơn,Thiết Nham,Thiết Đại,Thiết Cường,Thiết Lôi,Thiết Vi,Cường Sơn,Cường Nham,Lôi Sơn,Lôi Nham,Lôi Cường,Lôi Đại,Lôi Thạch,Lôi Thiết,Lôi Vi,Vi Sơn,Vi Nham,Vi Cường,Vi Đại,Vi Thạch,Vi Thiết,Vi Lôi,Sơn Cường Hùng,Nham Đại Thạch,Thiết Cường Sơn,Lôi Hùng Vi,Đại Sơn Nham,Cường Thạch Lôi,Hùng Thiết Vi,Sơn Lôi Đại,Nham Cường Thiết,Thạch Hùng Sơn",
      },
      {
        name: "Vi Tộc",
        i: 49,
        ...
        d: "n",
        m: 0,
        b: "Vi Tiểu,Vi Hào,Vi Miễu,Vi Thỏ,Vi An,Vi Nho,Vi Linh,Vi Tiên,Vi Nhược,Tiểu Hào,Tiểu Miễu,Tiểu Thỏ,Tiểu An,Tiểu Nho,Tiểu Linh,Tiểu Tiên,Tiểu Nhược,Hào Miễu,Hào Thỏ,Hào An,Hào Nho,Hào Linh,Hào Tiên,Hào Nhược,Miễu Thỏ,Miễu An,Miễu Nho,Miễu Linh,Miễu Tiên,Miễu Nhược,Thỏ An,Thỏ Nho,Thỏ Linh,Thỏ Tiên,Thỏ Nhược,An Nho,An Linh,An Tiên,An Nhược,Nho Linh,Nho Tiên,Nho Nhược,Linh Tiên,Linh Nhược,Tiên Nhược,Vi Tiểu Hào,Tiểu An Linh,Hào Miễu Thỏ,An Nho Tiên,Linh Tiên Nhược,Vi An Tiểu,Thỏ Linh Hào,Miễu Nho Vi,Tiên An Nhược,Nho Tiểu Linh",
      },
      {
        name: "Hải Tộc",
        i: 50,
        ...
        d: "n",
        m: 0,
        b: "Hải Dương,Hải Ba,Hải Thủy,Hải Lan,Hải Triều,Hải Ngư,Hải Sông,Hải Trầm,Hải San,Dương Ba,Dương Thủy,Dương Lan,Dương Triều,Dương Ngư,Dương Sông,Dương Trầm,Dương San,Ba Thủy,Ba Lan,Ba Triều,Ba Ngư,Ba Sông,Ba Trầm,Ba San,Thủy Lan,Thủy Triều,Thủy Ngư,Thủy Sông,Thủy Trầm,Thủy San,Lan Triều,Lan Ngư,Lan Sông,Lan Trầm,Lan San,Triều Ngư,Triều Sông,Triều Trầm,Triều San,Ngư Sông,Ngư Trầm,Ngư San,Sông Trầm,Sông San,Trầm San,Hải Dương Ba,Thủy Lan Triều,Ngư Sông Trầm,Ba Thủy San,Dương Triều Hải,Lan Ngư Sông,Triều Trầm San,Hải Ba Thủy,Dương Ngư Lan,Sông San Trầm",
      },
      {
        name: "Thạch Tộc",
        i: 51,
        ...
        d: "n",
        m: 0,
        b: "Thạch Nham,Thạch Kim,Thạch Cường,Thạch Cổ,Thạch Phiến,Thạch Ngọc,Thạch Khoáng,Thạch Địa,Thạch Trầm,Nham Kim,Nham Cường,Nham Cổ,Nham Phiến,Nham Ngọc,Nham Khoáng,Nham Địa,Nham Trầm,Kim Cường,Kim Cổ,Kim Phiến,Kim Ngọc,Kim Khoáng,Kim Địa,Kim Trầm,Cường Cổ,Cường Phiến,Cường Ngọc,Cường Khoáng,Cường Địa,Cường Trầm,Cổ Phiến,Cổ Ngọc,Cổ Khoáng,Cổ Địa,Cổ Trầm,Phiến Ngọc,Phiến Khoáng,Phiến Địa,Phiến Trầm,Ngọc Khoáng,Ngọc Địa,Ngọc Trầm,Khoáng Địa,Khoáng Trầm,Địa Trầm,Thạch Kim Cường,Nham Phiến Ngọc,Cổ Khoáng Địa,Kim Ngọc Trầm,Cường Thạch Địa,Phiến Cổ Nham,Ngọc Kim Cường,Địa Trầm Thạch,Khoáng Nham Cổ,Cường Phiến Kim",
      },
      {
        name: "Vũ Tộc",
        i: 52,
        ...
        d: "n",
        m: 0,
        b: "Vũ Diệu,Vũ Phi,Vũ Phượng,Vũ Cánh,Vũ Lương,Vũ Ưng,Vũ Hạc,Vũ Bằng,Vũ Yến,Diệu Phi,Diệu Phượng,Diệu Cánh,Diệu Lương,Diệu Ưng,Diệu Hạc,Diệu Bằng,Diệu Yến,Phi Phượng,Phi Cánh,Phi Lương,Phi Ưng,Phi Hạc,Phi Bằng,Phi Yến,Phượng Cánh,Phượng Lương,Phượng Ưng,Phượng Hạc,Phượng Bằng,Phượng Yến,Cánh Lương,Cánh Ưng,Cánh Hạc,Cánh Bằng,Cánh Yến,Lương Ưng,Lương Hạc,Lương Bằng,Lương Yến,Ưng Hạc,Ưng Bằng,Ưng Yến,Hạc Bằng,Hạc Yến,Bằng Yến,Vũ Diệu Phi,Phượng Cánh Ưng,Hạc Bằng Yến,Diệu Phi Phượng,Lương Ưng Hạc,Vũ Yến Bằng,Cánh Diệu Phi,Phi Phượng Ưng,Vũ Hạc Lương,Diệu Cánh Yến",
      },
    ];
  }
}
